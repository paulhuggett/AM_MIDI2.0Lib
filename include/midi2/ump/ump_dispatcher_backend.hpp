...
template <typename Context> struct stream_base : public stream_pure<Context> {
  ...
  void device_identity_notification(Context, ump::stream::device_identity_notification const &) override { /* do nothing */ }
...
public:
  ...
  void device_identity_notification(Context context,
                                    ump::stream::device_identity_notification const &notification) const {
  ...
  void jr_configuration_notification(Context context,
                                     ump::stream::jr_configuration_notification const &notification) const {
