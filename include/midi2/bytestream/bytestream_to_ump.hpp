...
/// \file bytestream_to_ump.hpp
/// \brief  Defines the MIDI 1.0 bytestream to UMP translator.
...
public:
  ...
  /// \brief Sets the group number for UMP messages created by the translator.
  /// Any in-flight messages are lost.
  /// \param group The group number for UMP messages generated by the translator.
  void set_group(std::uint8_t const group) noexcept;
  ...
  void push(input_type b) noexcept;
